    ...
    public static class RoslynBuilder
    {
            ...
            Type returnValueType)
        {
            return SyntaxFactory.MethodDeclaration(
                ...
                .WithAdditionalAnnotations(new SyntaxAnnotation(Annotations.MethodAnnotationKind, name))
                .WithModifiers(SyntaxFactory.TokenList(AccessibilityToSyntaxToken(accessibility).ToArray()));
        }
        ...
        public static SyntaxNode Assignment(SyntaxNode reference, SyntaxNode value)
        {
