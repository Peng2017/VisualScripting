...
namespace UnityEditor.VisualScripting.Editor
{
    partial class VseMenu
    {
        ...
        VisualElement m_PreviousErrorButton;
        VisualElement m_NextErrorButton;
        Label m_ErrorCounterLabel;
        VisualElement m_ErrorCounterContainer;

        void CreateErrorMenu()
        {
            m_ErrorIconLabel = this.MandatoryQ("errorIconLabel");

            m_PreviousErrorButton = this.MandatoryQ("previousErrorButton");
            ...
            m_ErrorCounterContainer = this.MandatoryQ("errorCounterContainer");
        ...
        void UpdateErrorMenu(bool enabled)
        {
            ...
            m_ErrorCounterContainer.SetEnabled(enabled);
