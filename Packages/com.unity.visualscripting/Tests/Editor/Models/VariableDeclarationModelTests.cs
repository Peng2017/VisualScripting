...
namespace UnityEditor.VisualScriptingTests.Models
{
    class VariableDeclarationModelTests
    {
        ...
        public void Test_FunctionParameterDeclarationsWithSameName()
        {
            ...
            var declaration0 = method.CreateFunctionParameterDeclaration("param", typeof(int).GenerateTypeHandle(graph.Stencil));
            var declaration1 = method.CreateFunctionParameterDeclaration("param", typeof(int).GenerateTypeHandle(graph.Stencil));
            Assert.That(declaration0, Is.Not.EqualTo(declaration1));
        ...
        public void Test_FunctionVariableDeclarationsIsSerializedInGraphAsset()
        {
            ...
            string nodeModelPath = AssetDatabase.GetAssetPath((NodeModel)declaration.InitializationModel);
