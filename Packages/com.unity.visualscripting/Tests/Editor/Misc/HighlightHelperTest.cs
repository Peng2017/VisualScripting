...
namespace UnityEditor.VisualScriptingTests.Misc
{
    ...
    sealed class HighlightHelperTest
    {
        ...
        public void SetUp()
        {
            ...
            m_Stencil = ScriptableObject.CreateInstance<ClassStencil>();

            var graphModel = ScriptableObject.CreateInstance<VSGraphModel>();
            graphModel.AssetModel = ScriptableObject.CreateInstance<VSGraphAssetModel>();
            graphModel.Stencil = m_Stencil;
            ...
            m_IntTokenModel = ScriptableObject.CreateInstance<VariableNodeModel>();
            m_IntTokenModel.DeclarationModel = intVariableModel;
            m_IntTokenModel.GraphModel = graphModel;

            m_StringTokenModel = ScriptableObject.CreateInstance<VariableNodeModel>();
