...
#pragma warning restore CS0414
        ...
        public void TestWithVisualScriptingNodesInStack(Type nodeType, bool acceptNode, bool result)
        {
            ...
            var filter = new SearcherFilter(SearcherContext.Graph).WithVisualScriptingNodes(stackMock.Object);
        }
        ...
        {
            var filter = new SearcherFilter(SearcherContext.Graph).WithGroup();
            var data = new SearcherItemData(SearcherItemTarget.Group);
