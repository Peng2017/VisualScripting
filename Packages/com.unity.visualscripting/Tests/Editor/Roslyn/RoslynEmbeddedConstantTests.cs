...
namespace UnityEditor.VisualScriptingTests.Roslyn
{
    class RoslynEmbeddedConstantTests : BaseFixture
    {
        ...
        public void Test_EmbeddedConstantIsUsedWhenDisconnected([Values] TestingMode mode)
        {
            ...
            FunctionCallNodeModel abs = GraphModel.CreateNode<FunctionCallNodeModel>("Abs", Vector2.zero, n => n.MethodInfo = absMethod);
            ((FloatConstantModel)abs.InputConstants[0]).value = innerValue;

            GraphModel.CreateEdge(log.InputPortModels.Single(), abs.OutputPortModels.Single());
            ...
            TestPrereqActionPostreq(mode,
                () =>
                {
                    ...
                    return new CreateEdgeAction(abs.InputPortModels.Single(), outerFloat.OutputPortModels.Single());
                },
                () =>
                {
