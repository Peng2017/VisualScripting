...
namespace UnityEditor.VisualScriptingTests.Roslyn
{
    class RoslynBuilderTests : BaseFixture
    {
        ...
        public void Test_Translate_Constructor()
        {
            ...
            FunctionCallNodeModel log = a.CreateStackedNode<FunctionCallNodeModel>("Log", 0, n => n.MethodInfo = logMethod);

            // new Vector4(x, y)
            ConstructorInfo ctor = typeof(Vector4).GetConstructor(new[] { typeof(float), typeof(float) });
            Assume.That(ctor, Is.Not.Null);
            FunctionCallNodeModel newV4 = GraphModel.CreateNode<FunctionCallNodeModel>("New Vector4", Vector2.left * 200, n => n.MethodInfo = ctor);

            GraphModel.CreateEdge(log.InputPortModels.First(), newV4.OutputPortModels.Single());
        ...
        public void Test_Translate_SimpleMethod2Params()
        {
            ...
            a.CreateFunctionParameterDeclaration("a", typeof(int).GenerateTypeHandle(GraphModel.Stencil));
        ...
        public void Test_Translate_DetectInfiniteLoop()
        {
            ...
            GraphModel.CreateEdge(stack0.InputPortModels[0], function.OutputPortModels[0]);
            GraphModel.CreateEdge(stack0.InputPortModels[0], stack1.OutputPortModels[0]);
            GraphModel.CreateEdge(stack1.InputPortModels[0], stack0.OutputPortModels[0]);
        ...
        public void Test_Initialized_Local_Variable()
        {
            ...
            mock.Setup(decl => decl.InitializationModel).Returns(GraphModel.CreateConstantNode("var1_init", typeof(int).GenerateTypeHandle(GraphModel.Stencil),
                Vector2.zero, NodeCreationMode.Orphan));
